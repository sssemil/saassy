...
export default function DeveloperConsoleActions({
  ...
  return (
    <div style={{ display: "grid", gap: 20 }}>
      {isFrozen && (
        <section style={card}>
          <h2 style={{ fontSize: 16, marginBottom: 8 }}>Account frozen</h2>
          <p style={{ marginBottom: 0, color: "var(--text-warning)" }}>
            Your developer account is frozen. Existing keys will not authorize
            bucket access, and self-service changes are disabled until an admin
...
function KeyCard({
  ...
  const mutationsDisabled = isFrozen || status !== "active";
        ...
        <div style={{ display: "grid", gap: 8 }}>
          ...
          >
            ...
            <input
              ...
              disabled={matchType === "all" || isFrozen}
